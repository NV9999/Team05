...
const MaintenanceRequestSchema = new mongoose.Schema({
    ...
    priority_level: { type: String, enum: ['low', 'medium', 'high'], default: 'medium' },  // New field to set the priority level
    expected_completion: { type: Date },  // Expected completion date for the maintenance task
    admin_id: { type: mongoose.Schema.Types.ObjectId, ref: 'Admin' },  // Admin or manager handling the request
