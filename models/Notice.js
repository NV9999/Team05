...
const NoticeSchema = new mongoose.Schema({
    ...
    notice_number: { type: Number, required: true, unique: true}, // Number of the notice
    admin_id: { type: mongoose.Schema.Types.ObjectId, ref: 'Admin', required: true },  // Foreign key reference to Admin model (admin)
